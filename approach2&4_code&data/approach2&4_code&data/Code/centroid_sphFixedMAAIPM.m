function [IPMx, iter, optval,alltime,fea,iter_hist,optval_hist] = centroid_sphFixedMAAIPM(stride, supp, w, c0, options)
...
% and Haoyue Wang (wanghaoyue3@outlook.com)
