...
% Solve barycenter
tic
[X_final, a_final, objective_values] = free_support_barycenter(Y_list, b_list, a_init, X_init, 1e-3, 0.1, 0.5, 0.7, 1e-10, 500, true);
toc
...
function [X, a, objective_values] = free_support_barycenter(Y_list, b_list, a_init, X_init, stopThr, reg, beta, theta, t_0, numItermax, verbose)
    ...
    for k = 1:numItermax
        ...
        if dX < 5e-2 && da < 1e-3 && objective_gap < 1e-3
            break;
        end
    end
end
